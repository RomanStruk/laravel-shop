                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="d-single-info">
                            <p class="user-name">Hello <span>{{ Auth::user()->email }}</span></p>
                            <p>(not {{ Auth::user()->email }}?
                            <a href="{{ route('logout') }}"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-single-info text-center">
                            <a class="view-cart" href="{{url('cart')}}"><i class="fa fa-cart-plus" aria-hidden="true"></i>view cart</a>
                        </div>
                    </div>
                </div>
            </div>
