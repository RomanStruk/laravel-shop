            ...
            <table class="table text-center compare-content">
                ...
                <tr>
                    ...
                    <td class="product-description">
                        <div class="compare-details">
                            <div class="compare-detail-img">
                                <a href="#"><img src="img/products/3.jpg" alt="compare-product"></a>
                            </div>
                    ...
                    <td class="product-description">
                        <div class="compare-details">
                            <div class="compare-detail-img">
                                <a href="#"><img src="img/products/2.jpg" alt="compare-product"></a>
                            </div>
                            <span>Tools</span>
                            <h4><a href="product.html">Products Name Here</a></h4>
                        </div>
                    ...
                    <td class="product-description">
                        <div class="compare-details">
                            <div class="compare-detail-img">
                                <a href="#"><img src="img/products/1.jpg" alt="compare-product"></a>
                            </div>
                            <span>Tools</span>
                            <h4><a href="product.html">Products Name Here</a></h4>
                        </div>
